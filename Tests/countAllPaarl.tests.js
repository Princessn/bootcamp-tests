describe("The countAllPaarl function", function () {
    it("It should return 2 registrations from the string when countAllPaarl is passed ", function () {
      assert.equal(2, countAllPaarl("CJ 275, CA 501, CY 329, CJ 107"));
    });
    it("It should return only 1 registration number from thestring when countAllPaarl is passed", function () {
    ...
    it("It should return 3 registrations from the string when countAllPaarl is passed", function () {
